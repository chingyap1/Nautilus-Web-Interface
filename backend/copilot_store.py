...
def build_supervisor_messages(
    ...
    system = (
        ...
        "optimise_params, registry_status, propose_registry_patch) may be "
        "suggested; the operator can also run them via the workspace Run "
        "experiment controls. Registry patches require human approve+apply and "
        "never git push. Never claim a paper deploy occurred.\n\n"
